...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-021-large-sieve-and-quadratic-sets-0bd11ef8-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-021"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-021-large-sieve-and-quadratic-sets-0bd11ef8-v1",
      "problem_contract_sha256": "8fe357dd83797a0e327753d2bdc57d59b4822a7fc8cad952f4ee30a59db20f26",
      "problem_id": "problem:um-green-021-large-sieve-and-quadratic-sets-0bd11ef8",
      "route_id": "route:um-green-021-large-sieve-and-quadratic-sets-0bd11ef8-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-021-large-sieve-and-quadratic-sets-0bd11ef8-source-fidelity-01",
      "graph_id": "graph:um-green-021-large-sieve-and-quadratic-sets-0bd11ef8-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-021-large-sieve-and-quadratic-sets-0bd11ef8-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-021-large-sieve-and-quadratic-sets-0bd11ef8-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Suppose that a large sieve process leaves a set of quadratic size. Is that set quadratic?"
          },
          "statement_sha256": "f4ac34cae587afd7f91d1fc3aef0acee0d4fdf19e3748c7f433407cf65d669f1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-021-large-sieve-and-quadratic-sets-0bd11ef8-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-021-large-sieve-and-quadratic-sets-0bd11ef8-root",
      "route_id": "route:um-green-021-large-sieve-and-quadratic-sets-0bd11ef8-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-021-4f94bd4e695a",
        "url": "https://www.unsolvedmath.com/problems/GREEN-021"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
